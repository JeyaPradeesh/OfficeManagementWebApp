...
<body style="background-color: #d9d7de">
	<div style="width: 100%; height: auto">
		...
		<a>Office Manager</a> <a href="LoginPage.jsp"
			style="text-decoration: none; padding-left: 930px; font-size: 25px; color: white"><img
			src="logout-512.png" style="width: 18px; height: 18px">&nbsp
			Logout</a> </header>
		<section style="width:100%;height:600px;"> <aside
			style="float:left;width:226px;height:600px;background-color:#1b1c1c">
		<div id="admin" style="background-color: #070808; height: 90px">
			<img src="kindpng_101213.png"
				style="width: 30px; hieght: 40px; padding: 10px 0px 0px 10px"><a
				style="color: #F0FFF0;">&nbsp Administrator</a>
		</div>
		<br>
		<div style="height: 465px">
			<h3 id="dash">
				<img src="dashboard-512.png" style="width: 18px; height: 18px"><a
					href="OfficeLobby.jsp" style="text-decoration: none; color: white">&nbsp
					Dashboard</a>
			</h3>
			<br>
			<h3 id="dash">
				<img src="Departmenticon.png" style="with: 18px; height: 18px"><a
					href="Department.jsp" style="text-decoration: none; color: white">&nbsp
					Department</a>
			</h3>
			<br>
			<h3 id="dash">
			...
			<br>
			<h3 id="dash">
				<img src="leave.png" style="width: 18px; height: 18px"><a
		...
		<section style="width:83%;height:600px;float:left"> <aside
			style="width:100%;height:30px"> <b
			style="color:Black; font-size: 40px; height: 20px">Staff</b> </aside>
		<div>
			<h2 style="font-size:30px">List of Staffs</h2><hr>
			
			<div style="text-align:left">
				<button><a href="StaffAdd.jsp" style="font-size:20px;color:ghostwhite;text-decoration:none">
						Add New Staff</a>
				</button>
			</div>
			<br>
...
%>		
				<tr>
				   ...
				   href="StaffUpdate.jsp">
				  Edit</a>&nbsp&nbsp
		          <a href="sdelete.jsp?id=<%=rs.getString("id")%>"
